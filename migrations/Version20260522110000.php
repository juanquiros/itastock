...
final class Version20260522110000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiscal_rules ADD CONSTRAINT FK_FISCAL_RULE_PRODUCT FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE fiscal_rules ADD CONSTRAINT FK_FISCAL_RULE_CATEGORY FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE fiscal_rules ADD CONSTRAINT FK_FISCAL_RULE_CUSTOMER FOREIGN KEY (customer_id) REFERENCES customer (id) ON DELETE CASCADE');
