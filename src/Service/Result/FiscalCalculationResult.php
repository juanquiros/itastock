...
{
    public function __construct(private array $manualComponents, private array $automaticComponents, private array $allComponents, private string $fiscalComponentsTotal, private array $warnings = []){}
